...
class ForgerAgent:
    def __init__(self, model_name="google/gemini-2.0-flash-lite-001", provider="cloud"):
        self.id = "FORGER AGENT"
        self.brain = AgentConnector(agent_name=self.id, provider=provider, model_name=model_name)
